...
class ODIN_API UOdinRoomJoin : public UBlueprintAsyncActionBase
{
  ...
  public:
    ...
    static UOdinRoomJoin *JoinRoom(UObject *WorldContextObject, UPARAM(ref) UOdinRoom*& room, const FString url,
...
class ODIN_API UOdinRoomAddMedia : public UBlueprintAsyncActionBase
{
  ...
  public:
    ...
    static UOdinRoomAddMedia *AddMedia(UObject *WorldContextObject, UPARAM(ref) UOdinRoom*& room,
                                       UPARAM(ref) UOdinCaptureMedia*& media, const FOdinRoomAddMediaError &onError,
  ...
  public:
    UFUNCTION(BlueprintCallable,
              meta = (BlueprintInternalUseOnly = "true", Category = "Odin|Sound",
                      ...
                      WorldContext = "WorldContextObject", AutoCreateRefTerm = "onSuccess,onError"))
    static UOdinRoomRemoveMedia *RemoveMedia(UObject *WorldContextObject, UPARAM(ref) UOdinRoom *&room,
  ...
  public:
    UFUNCTION(BlueprintCallable,
              meta = (BlueprintInternalUseOnly = "true", Category = "Odin|Room",
                      ...
                      WorldContext = "WorldContextObject", AutoCreateRefTerm = "onSuccess,onError"))
    static UOdinRoomUpdatePosition *UpdatePosition(UObject *WorldContextObject, UPARAM(ref) UOdinRoom *&room,
                                                   FVector2D                             position,
...
class ODIN_API UOdinRoomUpdatePeerUserData : public UBlueprintAsyncActionBase
{
  ...
  public:
    ...
    UpdatePeerUserData(UObject *WorldContextObject, UPARAM(ref) UOdinRoom *&room, const TArray<uint8> &data,
...
class ODIN_API UOdinRoomUpdateRoomUserData : public UBlueprintAsyncActionBase
{
  ...
  public:
    ...
    UpdateRoomUserData(UObject *WorldContextObject, UPARAM(ref) UOdinRoom *&room, const TArray<uint8> &data,
  ...
  public:
    UFUNCTION(BlueprintCallable,
              meta = (BlueprintInternalUseOnly = "true", Category = "Odin|Custom Data",
                      ...
                      WorldContext = "WorldContextObject", AutoCreateRefTerm = "onSuccess,onError"))
    static UOdinRoomSendMessage *SendMessage(UObject *WorldContextObject, UPARAM(ref) UOdinRoom *&room,
